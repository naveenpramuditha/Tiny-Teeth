	...
	<div class='sidebar'>
		<div class='sidebar-area'> 
			...
			<ul class='sidebar-menu'>
				...
				<li><a href='add-patient.php'><img class='sidebar-menu-icon' src='images/ic_group_add_white.png'  /> Add Patients</a></li>
				...
				<li><a href='xray.php'><img class='sidebar-menu-icon' src='images/ic_group_add_white.png'  /> Xray Reports</a></li>
	...
	<div class='sidebar'>
		<div class='sidebar-area'> 
			...
			<ul class='sidebar-menu'>
				...
				<li><a href='appointments.php'><img class='sidebar-menu-icon' src='images/ic_alarm_white_24dp.png'  /> Appointment</a></li>
				<li><a href='view.php'><img class='sidebar-menu-icon' src='images/ic_group_add_white.png'  /> Xray Reports View</a></li>
				<!--<li><a href='enquiry.php'><img class='sidebar-menu-icon' src='images/ic_help_outline_white_24dp.png'  /> Enquiry</a></li>-->
